...
It contains the following items:
	...
	dp_socket_july15_english.pdf				---> the text of the exam (English version)
	dp1_socket_lug15_italian.pdf				---> the text of the exam (Italian version)
	test.sh							---> the script you need to launch in order to test your solution
	source/types.x						---> the specification of the XDR types to be used
	README.txt						---> this file

To launch the test please use the following command:
./test.sh
The script will compile your solutions (as described in the exam text) and will run tests.
